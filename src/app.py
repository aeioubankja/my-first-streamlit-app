...
mpg_df = load_data(path="./data/mpg.csv")
mpg_df = deepcopy(mpg_df) # for security

st.title('My 1st version')
st.header('MPG data exploration')
# If you call "mpg_df", It's will show static data
# If you call with st., It's will call interactive


if st.sidebar.checkbox("Show dattaframe"):
    # If you call "mpg_df", It's will show static data
    # If you call with st., It's will call interactive
